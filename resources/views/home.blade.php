...
<head>
    ...
    <title>{{ $title ?? 'Sistem Informasi Dashboard Contact Person' }}</title>
    ...
    <style>
        body {
            background-image: url({{ asset('img/background_web.jpg') }});
                ...
                <div class="flex justify-center space-x-4 mt-10">
                    @auth
                        @if ($userDivision === 'O2222' && $userDept === 'O1900')
                            <a href="{{ route('warehouse.dashboard') }}" class="btn btn-md btn-error ">
                                <i class="fas fa-box"></i> Warehouse Dashboard
                            </a>
                        @elseif ($userDivision === 'O0000' && in_array($userDept, ['O1100', 'O1200', 'O9400']))
                            <a href="{{ route('store.dashboard') }}" class="btn btn-md btn-error ">
                        ...
                        @elseif (in_array($userDivision, ['C0000', 'F0000', 'G0000', 'H0000', 'K0000', 'M0000', 'R0000', 'YY000']) &&
                            ...
                            <a href="{{ route('office.dashboard') }}" class="btn btn-md btn-error ">
                                <i class="fas fa-building"></i> Office Dashboard
                            </a>
                        @endif
                    @else
