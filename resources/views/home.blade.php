    ...
    <body class="min-h-screen flex flex-col">
        ...
        <section class="hero flex items-center justify-center bg-cover bg-center min-h-screen text-white">
            <div class="container mx-auto text-center p-6">
                <<<<<<< HEAD <h1 class="text-5xl font-bold mb-4">Dashboard Contact Person</h1>
                    =======
                    ...
                    @endphp
                    @if (Route::has('login'))
                        <<<<<<< HEAD <div class="flex justify-center space-x-4 mt-4">
                            =======
                            <div class="flex justify-center space-x-4 mt-10">
                                ...
                                @auth
                                    ...
                                    @endif
                                @else
                                    <<<<<<< HEAD <a href="{{ route('login') }}" class="btn btn-outline">
                                        =======
