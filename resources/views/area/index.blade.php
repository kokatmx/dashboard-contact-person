<x-app-layout>
    <div class="container py-11 mx-auto sm:px-6 lg:px-8">
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="bg-yellow-500 text-white text-center py-6">
            ...
            <div class="p-6 text-gray-900">
                ...
                <a href="@if ($userDivision === 'O2222' && $userDept === 'O1900') {{ route('warehouse.dashboard') }}
                    ...
                    {{-- class="inline-block bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600 transition"> --}} class="btn btn-error text-white">
                    Kembali
                </a>
                ...
                <div class="mt-10">
                    <h2 class="text-xl font-semibold text-gray-800 mb-5"><a
                            href="{{ route('area.details', $area->area_name) }}">Daftar Departemen</a></h2>
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        @else
                                            <p class="text-gray-700">Karyawan: <span
                                                    class="font-bold">{{ $usersPerDepartment[$department->department_id]->users_count ?? 0 }}</span>
                                            </p>
