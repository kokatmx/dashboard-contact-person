<x-app-layout>
    <div class="container py-11 mx-auto sm:px-6 lg:px-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <!-- Welcome Card -->
            <div class="bg-red-500  text-black rounded-xl shadow-xl p-8 backdrop-blur-lg border border-gray-200">
                ...
                <div class="grid gap-4 mt-6">
                    ...
                    <div class="flex items-center bg-white shadow-md rounded-lg p-4 border-l-4 border-yellow-400">
                        ...
                        <p class="text-lg font-medium">
                            Department: <span
                                class="font-semibold">{{ Auth::user()->department->department_name }}</span>
                        </p>
                    </div>
                    <!-- Position Info -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
                @foreach ($areas as $area)
                    ...
                    @endphp
                    <div
                        class="relative rounded-lg shadow-xl overflow-hidden transform transition-transform hover:scale-105">
                        <div
