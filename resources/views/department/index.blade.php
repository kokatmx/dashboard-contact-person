        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                ...
                {{-- <form action="{{ route('department.search') }}" method="GET" class="my-6">
                    ...
                    <button type="submit" class="btn btn-primary btn-md text-white p-4 ml-2">Search</button>
                </form> --}}
                <!-- Error Message -->
                @if (session('error'))
                ...
                @endif
                <!-- Department List -->
                <h2 class="text-2xl font-semibold text-gray-800 mt-10">List Departemen</h2>
                ...
                <h2 class="text-2xl font-semibold text-gray-800 mt-10 ">List Departemen
                    Lainnya</h2>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:mt-3">
